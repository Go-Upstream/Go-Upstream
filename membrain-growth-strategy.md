# Membrain — Growth Strategy Brainstorm

*Prepared for George Brontén (majority owner) · July 2026 · Working draft for discussion with Henrik*

---

## 1. Where the company actually stands

Facts on the table, stated plainly:

- ~200 customers after 14 years, concentrated in English-speaking markets plus Sweden.
- 28 people (17 SE, 10 US, 1 IE), not profitable.
- Pricing roughly $49–89/user/month — between HubSpot and Salesforce, but far below the value of embedded methodology (Salesforce needs $165+/user plus add-ons to match guided selling).
- Strong product reputation in the niche: G2 4.6/5, repeatedly named top sales CRM / sales enablement tool, praised specifically for process guidance and support.
- Positioning has cycled through four category labels in a crowded market.
- AI is a live threat: customers who use only a fraction of the platform are starting to build their own tooling.

The honest read: Membrain has won its reputation but not its market. Fourteen years in, ~200 customers and no profit means the current motion — whatever its quality — does not compound. A growth plan that is "do the same, but harder" is not a plan. The brainstorm below is organized around the few decisions that would actually change the trajectory.

---

## 2. The owner-level decision that comes before any tactic

As majority owner who is no longer operational, your first decision is not marketing — it is which game Membrain is playing. Three coherent paths:

**Path A — Profitable niche leader.** Accept that this is a niche (complex B2B sales, mid-market) and dominate it profitably. Cut to break-even fast, grow through partners and expansion revenue, become the default platform of the sales-effectiveness world. Compounds slowly but removes fragility, and a profitable niche SaaS with high NRR is sellable at any time.

**Path B — Raise and swing.** Take outside capital to buy growth in a crowded market against HubSpot's distribution and Salesforce's ecosystem. Given 14 years of evidence about the niche's size and sales cycle, this is the weakest option — the market has already told you how fast it lets you grow.

**Path C — Strategic combination.** Merge with or sell to someone who needs what Membrain has: a sales-training conglomerate wanting a software layer, a PE roll-up of sales-tech assets, or a mid-market CRM wanting a complex-sales tier.

**Recommendation: Path A, executed so that Path C stays available.** Unprofitable + AI uncertainty is the fragile combination; profitability is the strategic move, not just the financial one. Everything below assumes Path A.

---

## 3. Positioning: stop naming categories, start naming the enemy

Four category labels in fourteen years ("Active Pipeline Management," "Sales Effectiveness Platform," "Sales Enablement CRM," "B2B Growth Platform") is the tell. Category creation is a venture-scale marketing spend; Membrain cannot win a category war and doesn't need to. "B2B Growth Platform" is the weakest of the four — every vendor claims growth, and it says nothing about who it's for.

What has always been true, and what customers and G2 reviewers actually buy, is the *thesis*: **how you sell is why you win**. The positioning that matches it is not a category but a who/what statement with an enemy:

> *For teams selling complex B2B deals — long cycles, many stakeholders — Membrain turns your sales methodology into daily behavior. CRMs record what happened; Membrain drives what happens next.*

The enemy is the administrative CRM ("a database your reps resent updating"). The differentiator is methodology-made-operational. That is concrete, defensible, and — critically for §5 — it is the one thing generic AI does *not* commoditize.
...
**Decision update (July 2026): Henrik has decided to lower partner focus in favor of the direct sales motion. This section's analysis stands, but its investment items are deferred.** What survives immediately is only what *frees* capacity: the triage (long tail to a no-touch community tier, zero partner-manager time) and keeping the handful of genuinely active partners warm. The certified-tier build-out — console, global recruiting, front-door redesign — goes on the shelf until the direct motion and the engineering rebuild (§6) are funded.

**KPI correction (late July 2026): the data puts a hard constraint on this decision. Partners sourced 61% of all sales projects in the last 365 days (253 of ~415); marketing sourced 22% (93).** Both facts hold at once: most of the 119 partners never refer, *and* a small active subset is the company's primary demand engine. So the long tail can be demoted for free, but partner focus as a whole cannot be dialed down until the direct engine out-produces its 22% — **sequence, not substitution**. Required analysis: identify exactly which partners drive the 61%, and compare win rate and deal size by source; if partner-sourced deals win more and are bigger (trust transfer usually does that), the active few deserve *more* attention even while the program shrinks. Supporting signal: organic new clients in Belgium, Germany, Singapore, and Mexico — zero-cost, almost certainly partner- or inbound-driven.
...
**Lessons from the methodology-edition experiment.** Membrain has already tried productizing partner IP as branded "methodology editions" (e.g., the Baseline Selling edition): significant joint build time, no market interest. The post-mortem matters because the failure was structural, not executional. (1) Demand for a methodology-by-name doesn't exist at the software layer — the addressable market of each edition is that trainer's active client base, people the trainer would have brought anyway; a landing page cannot create demand for a personal brand it doesn't own. (2) A pre-packaged edition is the wrong artifact for complex-sales buyers, whose whole reason for choosing Membrain is getting *their* process operationalized. (3) Months of bespoke build per edition against one consultancy's worth of distribution is upside-down economics. The editions were the right asset monetized at the wrong layer with the wrong distribution — the corrections are below.

- **Certified tier: a concentrated bet on ~10–15 firms, invite-only.** The profile is known from the partners who actually work: tech-savvy, growth-minded, motivated by stickiness / behavior enforcement / embedding their content — not commissions — anti-mainstream-vendor by temperament, and willing to co-sell (they push back when a prospect says "we already have a CRM"). That profile is maybe 5–10% of the sales-training population, so the tier isn't "the best of the current 119" — it is *everyone worldwide who fits*, and recruiting the next ten of them is a named job. What the tier gets:
  - **A methodology encoding toolkit, not bespoke editions.** One AI-powered capability replacing N hand-built editions: the partner feeds in playbooks, decks, videos, call recordings; AI drafts the process stages, milestones, qualification criteria, scorecards, and coaching prompts in Membrain; the partner reviews and adjusts. Months of joint engineering becomes days of partner self-service — the cost asymmetry that killed the editions disappears, and "embedding content," the thing the best partners actually want, becomes routine per-engagement work instead of a special project.
  - **The encoded methodology's real job is fueling the AI coach** (§5) — automated deal reviews, between-session reinforcement, and coaching prompts grounded in *the partner's* framework. Worth little as a SKU; worth a lot as the configuration layer that makes behavior stick. This is where the partner strategy and the AI strategy become one system.
  - **A partner console** — one multi-client view to run their programs, coach, and benchmark across every client on Membrain. Membrain becomes how they scale delivery, so each new client of theirs lands on the platform by default.
...
- **Fix the front door: application, not enrollment.** The current partner page (membrain.com/partner) has the right message — "87% of training is forgotten within a month without reinforcement" is exactly what the best partners buy — but the wrong funnel: "Sign up today!" open enrollment is the machine that built 119 mostly-dormant partnerships, optimizing for count over fit. And its Referral → Certified → Impact ladder assumes partners climb; the data says good ones *arrive* fitting the profile. Replace open enrollment with application against a published bar (active clients to bring onto Membrain, co-sell commitment, comfort embedding IP in the platform). Scarcity is an asset with this species of partner: being one of ~15 certified partners globally is a status good in a way that being one of 5,000 HubSpot partners cannot be — showcase the certified few by name with client results as proof of selectivity. Retire the Impact tier's "productization of custom methodologies for global scaling" promise — the edition experiment's ghost — in favor of the encoding-toolkit-plus-coach mechanism.
- **Distribution unit: the engagement, not the landing page.** Membrain is bundled into the certified partner's program by default — "the program includes the platform that makes it stick," with first-year seats folded into or co-sold alongside the program fee. Program lifecycle mirrors observed best-partner behavior: co-sell in year one, embed by default thereafter. Existing methodology landing pages get demoted to co-marketing/SEO assets aimed at the partner's own audience, with zero expectation of cold demand.
...
*(Status, late July 2026: the MCP server is in development. The work below shifts from "decide" to "exploit": recruit the churn-risk design partners and announce the dated roadmap NOW — retention value starts at the announcement, not the release — and pair the beta with the manager's-morning-briefing prompt template so the Startpage learning starts on day one.)*
...
**The agent-layer shift: lean in, compete on judgment** *(added late July 2026, from MCP-beta feedback)*. Client leadership is strongly attracted to interacting with Claude/ChatGPT about anything in their business regardless of which system hosts the data (CRM, ERP, MA, BI). This movement cannot be fought — and Membrain shouldn't want to, because it converts the company's oldest thesis into its best AI-era asset. In an agent world, systems stop competing on interfaces and compete on what they contribute to the conversation. Transactional systems hold *what happened*; Membrain holds *how you win* — enforced process, stage adherence, stakeholder maps, win/loss patterns. A generic CRM tells the AI what's in the pipeline; only process-disciplined data tells it *which pipeline is real*. The claim: **"Your AI is only as good as your sales process"** — sloppy CRM data plus Claude yields confidently hallucinated forecasts; Membrain's process enforcement is what makes revenue data AI-trustworthy.

- **Compete at the tool layer, not the chat layer.** Everyone will expose MCP CRUD. Membrain exposes *judgment*: `assess_deal_risk`, `forecast_with_confidence`, `explain_win_loss`, `coaching_agenda` — tools returning verdicts grounded in the customer's methodology, not rows. Other systems answer queries; Membrain answers questions.
- **The comparison is the demo.** A split conversation — Claude grounded in a typical CRM vs. Claude grounded in Membrain. One gives vague summaries; the other names the three at-risk deals and why. Leadership buyers feel it in ninety seconds. Mostly prompt engineering, not code; build it before GA.
- **Be the best contributor, never the aggregator.** "Ask Membrain about your ERP" is Claude/ChatGPT/Copilot's fight. This also kills the tempting wrong project: a general-purpose in-app chatbot (the in-app coach stays — workflow, not aggregation).
- **Reprice before GA.** If leadership interacts via Claude and agents do some of the work, seats erode — and per-user pricing erodes with them. Platform fee plus agent/API access tiers puts the revenue where value is consumed and converts the seat-erosion threat into the model. Much harder to retrofit after the MCP ships free.
- **The moat moves into the data.** A customer leaving after two years loses the encoded methodology and accumulated adherence history that made their AI good at revenue questions — lock-in that compounds with usage. Lead-gen motion to match: an **"AI-ready revenue data" audit** — assess a prospect's CRM for AI-answerability, let the audit expose the gaps, let the fix be Membrain. Targets the leadership buyer riding exactly this enthusiasm.

**Elevate, the Startpage, and the frontline-manager problem** *(added late July 2026)*. Context: many customers' sales managers are promoted top sellers never trained to manage; they don't coach. Elevate was built for exactly this and uptake has been very low. The failure has the same shape as the methodology editions (no demand at that layer) and the partner program (no incentive at that node): **Elevate asks managers to add a new activity, and its persona is defined by not having that habit** — compounded by buyer/user mismatch (leadership buys it, managers don't use it) and by prep cost (reviewing a rep's deals before a 1:1 takes the hour a skill-insecure manager will always skip). The lesson across all three: Membrain wins by riding inside behavior that already happens, never by requesting new behavior.

- **The remodel direction is right, and it converges with the AI coach: the Startpage *is* the coach's delivery surface.** For a manager: "two deals need inspection (no economic buyer, stalled at stage 3); your 1:1 with Maria is at 14:00 — three questions to ask from her pipeline; the one metric that moved." AI does the preparation managers skip, collapsing coaching from a skill-plus-hours problem to a read-and-ask problem — removing the exact barriers behind the non-usage. For reps: "what to do next per our process." Scope discipline (one developer): a read-mostly assembly layer over existing data plus AI-generated guidance, not a rebuild.
- **The MCP server is a zero-UI prototype of the Startpage.** Once Membrain data is reachable from Claude, the manager's morning briefing can be generated today as a prompt template for design partners — learning which briefing content managers act on at near-zero engineering cost, before any screen is built. MCP-first doesn't delay the Elevate remodel; it de-risks it.
- **Elevate as foot-in-the-door for other-CRM customers: real option, wrong moment, cheap to test.** Three gates before building: (1) *data dependency* — coaching intelligence needs process-adherence data other CRMs don't capture; standalone Elevate risks degrading into generic coaching content competing with Gong-style tools on their turf; (2) *focus* — one developer, active churn crisis, and this company's history of spreading thin; (3) *the discipline rule* — never take a product with low engagement in-base (where you control all the data) to a wider market; that scales non-usage into bought churn. The near-free test: existing Salesforce plug-in capability + a landing page + outbound to a few dozen target accounts; measure pull before building. If the Startpage fixes in-base engagement first, the wedge becomes "your CRM stays, your managers finally coach," integrated via MCP rather than a rebuild.
- **Marketing takeaway regardless:** "your sales managers were never trained for the job" is a strong direct-motion campaign — a named, felt problem, backed by Membrain's own data, aimed at the actual economic buyer (CEO/VP), in the voice of ten years of the blog. It also sharpens the ICP: 1–3 promoted-seller managers overseeing 5–25 reps in complex sales.

Kill or don't start: any AI feature a horizontal CRM will ship as a checkbox.
...
**What the July 2026 KPIs add** *(interpreting chart figures as MRR in SEK — total base ≈ 2.33M SEK MRR / ~28M SEK ARR across ~200 customers; confirm)*:

- **Deal size is the canary.** New-business deal size fell from ~9.9K SEK (Oct–Nov 2025 peak) to ~5.7K and is still declining — smaller customers, fewer seats, or discounting. This connects directly to churn: small, low-seat customers who never adopt the full platform are exactly the build-your-own leavers, so the funnel may be manufacturing next year's churn. Actions: find what changed around November 2025, and set an ICP floor (minimum seats/complexity) below which deals are declined or routed to self-serve.
- **Growth math, concrete.** New business ≈ 304K SEK MRR over 365 days on a 2.33M base = ~13% gross growth *before* churn; with churn rising, net growth is plausibly zero or negative. Revenue per employee ≈ 1M SEK, roughly half of sustainable SaaS norms — the profitability gap is ~45–50M SEK ARR at current headcount, or fewer heads.
- **US restructure, data-backed.** US base 931K SEK MRR; US new business 137.7K SEK MRR/year (~1.65M SEK ARR) from a four-person org plausibly costing 8–10M SEK/year — five-plus kronor spent per krona booked, before asking how much of it was even partner-sourced. (Caveat: expansion revenue and per-deal sourcing aren't in these charts.)
- **Sweden hire math.** All of Sweden added 60.8K SEK MRR of new business last year; each Swedish sales FTE needs roughly 85K+ SEK MRR/year to pay for itself. The hiring plan assumes Sweden's new-business rate triples — demand pipeline evidence before the third hire.
- **Win-rate diagnostic.** ~415 sourced projects producing ~45 new clients is a ~13% win rate — for a sales-effectiveness company, the single most useful number to decompose in its own product: at which stage of Membrain's own process do deals die, and does it differ by source?
...
- **Instrument the basics first.** NRR, gross churn, expansion rate, CAC by channel, and module penetration (Prospecting / Active Pipeline / Account Growth / Elevate) per account. If NRR isn't ≥100%, fixing that outranks all acquisition work — a leaky base makes every marketing dollar worthless.
- **Cross-sell the suite.** Four products and (likely) low multi-module penetration is the cheapest revenue available. A named expansion motion — even 0.5 FTE — against the top 50 accounts.
- **Reprice for value.** $49–89/user is priced like a CRM while delivering methodology infrastructure that costs $165+ to approximate on Salesforce. Options: raise the top tier meaningfully; add a platform fee (which also monetizes the API/agent access from §5); value-price Elevate against training budgets (which are 10x software budgets) rather than software budgets. **Agent-era urgency:** per-seat pricing erodes as leadership interacts via Claude and agents do rep work — the platform-fee + agent-access-tier structure needs to be decided *before* the MCP server ships free at GA, not retrofitted after.
- **Rescue the at-risk segment.** The customers using a sliver of the platform are the churn/build-your-own risk. A low-touch "full-value onboarding" replay for the bottom quartile of usage is cheaper than replacing them.
- **Cost side.** 28 people across three countries serving 200 customers needs an honest zero-based review with Henrik. Profitability within 12–18 months should be a stated, non-negotiable goal — it converts every later choice (including Path C) from forced to optional.
...
3. **MCP server beta** — scoped, built without any of the contested practices if need be; 3–5 design partners recruited from the churn-risk list; public roadmap announcement with a real date. Include the manager's-morning-briefing prompt template as a zero-UI Startpage prototype with the same design partners. (Weeks 2–10)
...
5b. **Sales diagnostic in Membrain (§7)** — pipeline coverage, win rate by stage *and by source* (partner vs marketing), cycle, ACV, lead source per rep and region; identify which partners drive the 61% of sourced projects; decompose the ~13% win rate; explain the post-Nov-2025 deal-size decline; rebuild quotas bottom-up; pause the third Swedish sales hire and decide the US restructure on the evidence. (Weeks 1–5, before further sales hiring)
...
- **Editions déjà vu.** The encoding toolkit could fail like the methodology editions did if it's framed as a demand-gen SKU. The guardrails: no cold landing pages, no per-methodology engineering, distribution only through live engagements, and the toolkit's success metric is *activation and stickiness of accounts that used it* — not leads generated.
